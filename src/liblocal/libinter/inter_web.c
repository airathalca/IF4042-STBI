#ifdef RCSID
static char rcsid[] = "$Header: /home/smart/release/src/liblocal/libinter/inter_web.c,v 11.0 1992/07/21 18:22:13 chrisb Exp $";
#endif
 ...
 *0 Interactive commands, including the WEB command
 *1 inter.inter_web
 *2 inter_web(unused1,unused2,inst)
 *3    char *unused1;
 *3    char *unused2;
 *3    int inst;
 *4 init_inter_web(spec,unused)
 *5    "inter.verbose"
 *4 close_inter_web(inst)

 *7 Prompt the user for one of a series of commands and then execute
 *7 the commands.  This set of routines includes the WEB command for
 *7 generating a hypertext-style web of related documents.

 *9 This is merely a copy of the "inter" with the Web command added.
 *9 Changes between the two will probably get royally out of synch.
 *9 The "reset_is" routine is NOT included in this module.
...
int init_build_web(), build_web(), close_build_web();
/* int init_compare_docs(), compare_docs(), close_compare_docs(); */
int EMPTY();
...
static COMMAND advanced[] = {
    ...
    "Web <did>", init_build_web, build_web, close_build_web,
    2, 1, 0,
    "Build hypertext-like web of documents matching did",

/*    "Compare <did1> <did2>", init_compare_docs, compare_docs,
    close_compare_docs,
    2, 1, 0,
    "Display detailed comparisons between two documents",
*/
    NULL, NULL, NULL, NULL,
    1, 0, 0, ""
};
...
int
inter_web (unused1, unused2, inst)
