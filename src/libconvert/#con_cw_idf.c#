#ifdef RCSID
static char rcsid[] = "$Header: /home/smart/release/src/libconvert/con_cw_idf.c,v 11.0 1992/07/21 18:20:28 chrisb Exp $";
#endif
...
char *param_prefix;
{
    ...
    ip->inv_inst = UNDEF;
    ip->idf = (float *) simp_inv.list;
    ip->num_idf = simp_inv.num_list;
