#ifdef RCSID
static char rcsid[] = "$Header: /home/smart/release/src/libproc/proc_convert.c,v 11.0 1992/07/21 18:23:04 chrisb Exp $";
#endif
...
int init_tfwt_okapi(), tfwt_okapi();
static PROC_TAB proc_wt_tf[] = {
    ...
    "o",     init_tfwt_okapi,	      tfwt_okapi,    EMPTY,
};
...
int init_okapi(),  normwt_okapi(),  close_okapi();
...
/* Assumes phrase ctype is > regular ctype, so that C is called first */
    ...
    "o",               init_okapi,     normwt_okapi,  close_okapi, 
};
